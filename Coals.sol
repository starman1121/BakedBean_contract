...
/*
 ________  ________  ________  ___               _____ ______   ___  ________   _______   ________     
|\   ____\|\   __  \|\   __  \|\  \             |\   _ \  _   \|\  \|\   ___  \|\  ___ \ |\   __  \    
\ \  \___|\ \  \|\  \ \  \|\  \ \  \            \ \  \\\__\ \  \ \  \ \  \\ \  \ \   __/|\ \  \|\  \   
 \ \  \    \ \  \\\  \ \   __  \ \  \            \ \  \\|__| \  \ \  \ \  \\ \  \ \  \_|/_\ \   _  _\  
  \ \  \____\ \  \\\  \ \  \ \  \ \  \____        \ \  \    \ \  \ \  \ \  \\ \  \ \  \_|\ \ \  \\  \| 
   \ \_______\ \_______\ \__\ \__\ \_______\       \ \__\    \ \__\ \__\ \__\\ \__\ \_______\ \__\\ _\ 
    \|_______|\|_______|\|__|\|__|\|_______|        \|__|     \|__|\|__|\|__| \|__|\|_______|\|__|\|__|
...
contract BakedBeans is Context, Ownable {
    ...
    constructor(address _dev1, address _dev2, address _treasury) {
        dev1 = _dev1;
        dev2 = _dev2;
        treasury = _treasury;
    }
    ...
    function sellBones() public {
        ...
        uint256 devfee = fee.div(3);
        uint256 treasuryfee = fee.sub(devfee);
        payable(dev1).transfer(devfee.mul(15).div(100));
        payable(dev2).transfer(devfee.mul(85).div(100));
    ...
    function buyBones(address ref) public payable {
        ...
        payable(dev1).transfer(fee.mul(15).div(100));
        payable(dev2).transfer(fee.mul(85).div(100));
